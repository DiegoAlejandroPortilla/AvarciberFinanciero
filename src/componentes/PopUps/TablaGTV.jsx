...
const TablaTA = () => {
  ...
  const handleGuardar = async () => {
    if (modificarIndex !== -1) {
      ...
      await axios.put(`https://savarciberfinanciero-production.up.railway.app/api/tiposvulnerabilidad/${modificarIndex}`, formulario);
      // Now update the 'datos' state with the updated data
      const response = await axios.get('https://savarciberfinanciero-production.up.railway.app/api/tiposvulnerabilidad');
      setDatos(response.data);
    } else {
      // Agregar un nuevo dato
      await axios.post('https://savarciberfinanciero-production.up.railway.app/api/tiposvulnerabilidad', formulario);
  ...
  const handleEliminar = async (index) => {
    ...
    await axios.delete(`https://savarciberfinanciero-production.up.railway.app/api/tiposvulnerabilidad/${codigoToDelete}`);
